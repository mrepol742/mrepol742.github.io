...
<head>
  ...
  <meta property="og:image:alt" content="Webvium Beta">
  <meta property="twitter:image:src" content="https://mrepol742.github.io/images/webviumbeta.png" />
  <meta property="twitter:title"
    content="Download Webvium Beta - Lightweight, Fast, Material and Full-Featured Android Web Browser." />
  <meta property="twitter:description"
    content="Try out the pre-release version of Webvium. Comes with the newest features, bug fixes and improvements. The feedback you provide will help us address issues and make changes before rolling out the release." />
  <meta property="og:title"
    content="Download Webvium Beta - Lightweight, Fast, Material and Full-Featured Android Web Browser.">
  <meta property="og:url" content="https://mrepol742.github.io/webviumbeta">
  <meta property="og:site_name"
    content="Download Webvium Beta - Lightweight, Fast, Material and Full-Featured Android Web Browser.">
  <meta property="og:description"
    content="Try out the pre-release version of Webvium. Comes with the newest features, bug fixes and improvements. The feedback you provide will help us address issues and make changes before rolling out the release.">
  <meta property="og:image" content="https://mrepol742.github.io/images/webviumbeta.png">
  ...
  <link rel="canonical" href="https://mrepol742.github.io/webviumbeta">
  ...
  <link rel="search" type="application/opensearchdescription+xml" href="https://mrepol742.github.io/opensearch.xml"
    title="Search...">
  <script
    type="application/ld+json">{      "@context": "https://schema.org",      "@type": "SoftwareApplication",      "name": "Webvium Beta",      "operatingSystem": "ANDROID",      "applicationCategory": "BrowserApplication",      "aggregateRating": {        "@type": "AggregateRating",        "ratingValue": "4.6",        "ratingCount": "5500"      },      "offers": {        "@type": "Offer",        "price": "0"      }    }</script>
  ...
  <title>Download Webvium Beta - Lightweight, Fast, Material and Full-Featured Android Web Browser.</title>
</head>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link" href="/webvium/">Stable</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/webviumdev/">Development</a>
          </li>
        </ul>
        <div>
          <ul class="nav navbar-nav" style="flex-direction: row;">
            <li class="nav-item">
              <a class="nav-link" href="/webviumbeta/download">
  ...
  <main>
      ...
      <div class="card mb-3 ">
        <div class="row g-0">
          ...
          <div class="col-md-8">
            <div class="card-body">
              <br>
              <h1 class="card-title"><strong>Webvium Beta</strong></h1>
    ...
    <div class="images">
      <div class="holder">
        <video preload="none" class="preview0" controls poster="/images/webviumbeta.png">
          <source
        ...
        <img loading="lazy" class="preview" src="/images/webvium-1.jpg" alt="Webvium Beta App Screenshot">
        <img loading="lazy" class="preview" src="/images/webvium-2.jpg" alt="Webvium Beta App Screenshot">
        <img loading="lazy" class="preview" src="/images/webvium-3.jpg" alt="Webvium Beta App Screenshot">
        <img loading="lazy" class="preview" src="/images/webvium-4.jpg" alt="Webvium Beta App Screenshot">
        <img loading="lazy" class="preview" src="/images/webvium-5.jpg" alt="Webvium Beta App Screenshot">
        <img loading="lazy" class="preview" src="/images/webvium-6.jpg" alt="Webvium Beta App Screenshot">
        <img loading="lazy" class="preview" src="/images/webvium-7.jpg" alt="Webvium Beta App Screenshot">
        <img loading="lazy" class="preview" src="/images/webvium-8.jpg" alt="Webvium Beta App Screenshot">
      </div>
    </div>
    <br>
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="card mb-3 ">
          ...
          <div class="card-body">
            ...
            After updating, you cannot downgrade to the old version of this Software without uninstalling the new one.
      ...
      <div class="col-sm-6">
        <div class="card mb-3 ">
          <h5 class="card-header">Beta Test</h5>
          <div class="card-body">
            <p class="card-text">
              Test new features of Webvium Browser before it rollout. Report any Software crashes as soon as possible to
      ...
      <div class="col-sm-6">
        <div class="card mb-3 ">
          ...
          <div class="card-body">
            <p class="card-text">
              <a href="https://facebook.com/com.mrepol742.webvium.beta" style="padding-left: 5px; padding-right: 5px;"
                target="_blank">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                  <title>Webvium Beta's Facebook</title>
              ...
              <a href="https://www.pinterest.ph/mrepol742/webvium" style="padding-left: 5px; padding-right: 5px;"
                target="_blank">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                  <title>Webvium's Pinterest</title>
                  <path fill="currentColor"
          ...
          <div id="panelsStayOpen-collapseOne3" class="accordion-collapse collapse show"
            ...
            <div class="accordion-body">
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">Latest release: <span id="upda">August 19, 2022</span></li>
    ...
    <div class="card mb-5">
      <div class="card-body">
        ...
        <ul class="card-text">
          <li><a href="https://github.com/mrepol742/mrepol742.github.io/edit/master/webviumbeta/index.html"
              target="_blank">Edit on Github</a></li>
          <li><a href="https://github.com/mrepol742/mrepol742.github.io/blob/master/webviumbeta/index.html?plain=1"
  ...
  <script src="/js/webviumbeta.js"></script>
</body>
