<footer class="mt-5">
    <div class="container">
        <div class="row footer-row">
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/#workexp">Certificates</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="https://www.buymeacoffee.com/mrepol742"
                            >Buy Me a Coffee</a
                        >
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://www.patreon.com/melvinjonesrepol"
                            >Patreon</a
                        >
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://github.com/sponsors/mrepol742"
                            >Github Sponsor</a
                        >
                    </li>
                </ul>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="https://mrepol742.github.io/blog/hello-world/"
                            >Hello World - The Genesis</a
                        >
                    </li>
                    <li class="nav-item">
                        <a
                            ...
                            >Project Orion - Open Source Chatbot Revolutionizing Facebook
                            Messenger</a
                        >
                    </li>
                    <li class="nav-item">
                        <a
                            ...
                            >Webvium Latest Release - v2.9 stable</a
                        >
                    </li>
                    <li class="nav-item">
                        <a
                            ...
                            >Unleashing the Potential of AI - Exploring OpenAI's Cutting-Edge
                            Technology</a
                        >
                    </li>
                    <li class="nav-item">
                        <a
                            ...
                            >Webvium Browser - Lightweight, Fast & Full Featured</a
                        >
                    </li>
                    <li class="nav-item">
                        <a
                            ...
                            >Crafting Your Online Presence - Building a Blog with VuePress</a
                        >
                    </li>
                </ul>
            </div>
        ...
        <a href="https://youtube.com/@mrepol742" aria-label="Youtube" target="_blank">
            <i class="fa-brands fa-youtube px-1"></i> </a
        ><br />
