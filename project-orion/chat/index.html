...
<head>
    ...
    <meta property="twitter:description"
        content="Chat.io is a feature of Project Orion that's currently under development where in you can interact with the project AI. If you found any issues please let us know." />
    <meta property="og:title" content="Chat with Project Orion (Chatbot)">
    <meta property="og:url" content="https://mrepol742.github.io/project-orion/chat">
    <meta property="og:site_name" content="Chat with Project Orion (Chatbot)">
    ...
    <link rel="canonical" href="https://mrepol742.github.io/project-orion/chat">
    ...
    <meta name="keywords" content="melvin jones repol, mrepol742, project orion, chat.io">
    ...
    <title>Chat with Project Orion (Chatbot)</title>
</head>
...
<body class="d-flex flex-column min-vh-100">
                        ...
                        <li class="nav-item">
                            <div class="card-group">
                                <div class="card" style="background: transparent !important; border: none;">
                                    <div class="card-body">
                                        <h5>What is Project Orion?</h5>
                                        <p>
                                            A Chatbot thats trained to understand and respond to a wide range of
                                            commands and requests. Providing a valuable service that poeple find useful.
                                            Strive to create a platform that is easy to use and provides helpful
                                            features that make poeple's lives easier.</p>
                                        <ul>
                                            <li> <a href="/project-orion/">Project Orion</a></li>
                                            <li> <a href="/project-orion/termsofservice/">Terms of Service</a></li>
                                            <li> <a href="/project-orion/privacypolicy/">Privacy Policy</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="card" style="background: transparent !important; border: none;">
                                    <div class="card-body">
                                        ...
                                        Services
                                        <ul>
                                            <li> <a href="/webvium/">Webvium</a></li>
                                            <li> <a href="/webviumvpn/">Webvium VPN</a></li>
                                            <li> <a href="/search/">Webvium Search</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="card" style="background: transparent !important; border: none;">
                                    <div class="card-body">
                                        ...
                                        <ul>
                                            <li><a href="https://github.com/mrepol742/mrepol742.github.io/edit/master/project-orion/chat/index.html"
                                                    target="_blank">Edit on Github</a></li>
                                            <li><a href="https://github.com/mrepol742/mrepol742.github.io/blob/master/project-orion/chat/index.html?plain=1"
                                                    target="_blank">Source on Github</a></li>
                                            <li><a href="https://github.com/mrepol742/mrepol742.github.io/issues/new?">Report
                                                    a problem with
                                                    this content on GitHub</a></li>
                                        </ul><br>
                                        Support Project Orion<br>
    ...
    <main>
        <div class="toast" id="privacypolicy"
            style="position: fixed; bottom: 0; right: 0; z-index: 9999; float: right; margin: 3%;"
