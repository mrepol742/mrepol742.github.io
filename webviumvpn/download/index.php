...
<head>
  ...
  <meta property="twitter:title" content="Thank you for downloading - Webvium VPN" />
  <meta property="twitter:description"
    content="Webvium VPN inspired from Webvium, Webvium VPN is a lightweight android VPN app focuses in speed, simplicity, security and privacy." />
  <meta property="og:title" content="Thank you for downloading - Webvium VPN">
  <meta property="og:url" content="https://mrepol742.github.io/webviumvpn/download">

  <meta property="og:site_name" content="Thank you for downloading - Webvium VPN">
  ...
  <link rel="canonical" href="https://mrepol742.github.io/webviumvpn/download">
  ...
  <link rel="shortcut icon" href="/webviumvpn/favicon.png">
  <link rel="apple-touch-icon" href="/webviumvpn/favicon.png">
  ...
  <title>Thank you for downloading - Webvium VPN</title>
</head>
...
<body class="d-flex flex-column min-vh-100">
  ...
  <nav class="autohide navbar navbar-expand-lg fixed-top scrolled-up scrolled-up-tr">
    <div class="container-fluid">
      <a class="navbar-brand" href="/webviumvpn/">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link" href="/webviumvpn#features">Features</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/webviumvpn#info">Information</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/webviumvpn#dataSafety">Data Safety</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/webviumvpn#permissions">Permissions</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/webviumvpn#previousVersion">Previous Version</a>
          </li>
        </ul>
        <div>
  ...
  <main>
    ...
    <header class="mt-5">
      <h1 class="text-center2">Thank you for downloading Webvium VPN.</h1><br>
    </header>
    <div class="card ">
      <div class="card-body">
        <p>Within a few seconds, your download should begin automatically. If it doesn't, please
          start the <a href="https://github.com/mrepol742/released/blob/stable/Webvium%20VPN%20v1.0.apk?raw=true"
            id="retry-download" target="_blank">download using this link.</a></p>
        <br>
        <div class="row">
      ...
      <div>
        ...
        <a href="https://webvium-vpn.en.uptodown.com/android" target="_blank">
          <img loading="lazy" src="/images/uptodown.jpg" alt="Download Webvium VPN, Discover and Share" width="110" />
        </a> <a href="https://www.amazon.com/dp/B09TRT8PGF" target="_blank">
          <img loading="lazy" src="/images/available_at_amazon_en_horizontal.png" alt="Webvium VPN Available on Amazon"
            width="200" />
        </a>
      </div>
      <br>
      <div>
        ...
        <a href="https://ko-fi.com/mrepol742">
          <img loading="lazy"
            src="https://img.shields.io/badge/Ko--fi-F16061?style=for-the-badge&logo=ko-fi&logoColor=white" alt="Ko-Fi">
        </a>
      </div>
    </div>
    <br>
    <div class="card mb-5">
      <div class="card-body">
        ...
        <ul class="card-text">
          <li><a href="https://github.com/mrepol742/mrepol742.github.io/edit/master/webviumvpn/download/index.html"
              target="_blank">Edit on Github</a></li>
          <li><a
              href="https://github.com/mrepol742/mrepol742.github.io/blob/master/webviumvpn/download/index.html?plain=1"
  ...
  <script src="/js/webviumvpndownload.js"></script>
