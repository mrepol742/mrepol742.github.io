...
<head>
  ...
  <meta property="og:image:alt" content="Webvium VPN">
  <meta property="twitter:image:src" content="https://mrepol742.github.io/images/webviumvpn.png" />
  <meta property="twitter:title"
    content="Download Webvium VPN - Anonymous, Secured, Private and the fastest Virtual Private Network." />
  <meta property="twitter:description"
    content="Inspired from Webvium, Webvium VPN is a lightweight android VPN app focuses in speed, simplicity, security and privacy." />
  <meta property="og:title"
    content="Download Webvium VPN - Anonymous, Secured, Private and the fastest Virtual Private Network.">
  <meta property="og:url" content="https://mrepol742.github.io/webviumvpn">
  <meta property="og:site_name"
    content="Download Webvium VPN - Anonymous, Secured, Private and the fastest Virtual Private Network.">
  <meta property="og:description"
    content="Inspired from Webvium, Webvium VPN is a lightweight android VPN app focuses in speed, simplicity, security and privacy.">
  <meta property="og:image" content="https://mrepol742.github.io/images/webviumvpn.png">
  ...
  <meta name="keywords"
    content="melvin jones repol, mrepol742, webvium vpn, webvium vpn download, vpn download, best free vpn, vpn for android">
  ...
  <link rel="canonical" href="https://mrepol742.github.io/webviumvpn">
  ...
  <script
    type="application/ld+json">{      "@context": "https://schema.org",      "@type": "SoftwareApplication",      "name": "Webvium VPN",      "operatingSystem": "ANDROID",      "applicationCategory": "UtilitiesApplication",      "aggregateRating": {        "@type": "AggregateRating",        "ratingValue": "4.9",        "ratingCount": "6030"      },      "offers": {        "@type": "Offer",        "price": "0"      }    }</script>
  <script
    type="application/ld+json">{"@context":"https://schema.org","@type":"VideoObject","name":"Download Webvium VPN - Anonymous, Secured, Private and the fastest Virtual Private Network.","url":"https://mrepol742.github.io#projects","description":"Anonymous, Secured, Private and the fastest Virtual Private Network.","thumbnailUrl":"https://mrepol742.github.io/images/webviumvpn.png","uploadDate":"2023-07-23T08:00:00+08:00","duration":"PT23S","contentUrl":"https://mrepol742.github.io/videos/Webvium%20VPN%20-%20Anonymous,%20Secured,%20Private%20and%20the%20fastest%20Virtual%20Private%20Network.mp4","interactionStatistic":{"@type":"InteractionCounter","interactionType":{"@type":"WatchAction"},"userInteractionCount":102111}}</script>
  ...
  <title>Download Webvium VPN - Anonymous, Secured, Private and the fastest Virtual Private Network.</title>
</head>
...
<body class="d-flex flex-column min-vh-100">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        ...
        <div>
          <ul class="nav navbar-nav" style="flex-direction: row;">
            <li class="nav-item">
              <a class="nav-link" href="/webviumvpn/download">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/webviumvpn/privacypolicy/">
  ...
  <main>
    ...
    <header class="mt-5">
      <div class="card mb-3 ">
        <div class="row g-0">
          <div class="col-md-4">
            <img loading="lazy" src="/images/webviumvpn_transparent_icon.png" class="rounded mx-auto d-block img-fluid"
              alt="Webvium VPN" width="300">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <br>
              <h1 class="card-title"><strong>Webvium VPN</strong></h1>
    ...
    <div class="images">
      <div class="holder">
        <video preload="none" class="preview0" controls poster="/images/webviumvpn.png">
          <source
        ...
        <img loading="lazy" class="preview" src="/images/webvium-vpn-main-light.jpg" alt="Webvium VPN">
        <img loading="lazy" class="preview" src="/images/webvium-vpn-main-light-connected.jpg" alt="Webvium VPN">
        <img loading="lazy" class="preview" src="/images/webvium-vpn-main-dark.jpg" alt="Webvium VPN">
        <img loading="lazy" class="preview" src="/images/webvium-vpn-main-dark-connected.jpg" alt="Webvium VPN">
      </div>
    </div>
    <br>
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <div class="card mb-3 ">
          ...
          <div class="card-body">
            <p class="card-text">
              <a href="https://fb.com/com.samiunnafis.webviumvpn" style="padding-left: 5px; padding-right: 5px;"
                target="_blank">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                  <title>Webvium VPN's Facebook</title>
                  <path fill="currentColor"
                    d="M12 2.04C6.5 2.04 2 6.53 2 12.06C2 17.06 5.66 21.21 10.44 21.96V14.96H7.9V12.06H10.44V9.85C10.44 7.34 11.93 5.96 14.22 5.96C15.31 5.96 16.45 6.15 16.45 6.15V8.62H15.19C13.95 8.62 13.56 9.39 13.56 10.18V12.06H16.34L15.89 14.96H13.56V21.96A10 10 0 0 0 22 12.06C22 6.53 17.5 2.04 12 2.04Z" />
                </svg>
              </a>
              <a href="https://www.pinterest.ph/mrepol742/webvium-vpn" style="padding-left: 5px; padding-right: 5px;"
                target="_blank">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                  <title>Webvium VPN's Pinterest</title>
                  <path fill="currentColor"
          ...
          <div class="card-body">
            <p class="card-text">
              <a href="https://webvium-vpn.en.uptodown.com/android" target="_blank">
                <img loading="lazy" src="/images/uptodown.jpg" alt="Download Webvium VPN, Discover and Share"
                  width="110" />
              </a>
              <a href="https://www.amazon.com/dp/B09TRT8PGF" target="_blank">
                <img loading="lazy" src="/images/available_at_amazon_en_horizontal.png"
                  alt="Webvium VPN Available on Amazon" width="200" />
              </a>
            </p>
          </div>
        </div>
        ...
        <div id="panelsStayOpen-collapseOne3" class="accordion-collapse collapse show"
          ...
          <div class="accordion-body">
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item">OS: Mininum Android version 5.0 Lollipop</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-6" id="previousVersion">
        <div class="accordion ">
          <div class="accordion-item">
    ...
    <div class="card mb-5">
      <div class="card-body">
        ...
        <ul class="card-text">
          <li><a href="https://github.com/mrepol742/mrepol742.github.io/edit/master/webviumvpn/index.html"
              target="_blank">Edit on Github</a></li>
          <li><a href="https://github.com/mrepol742/mrepol742.github.io/blob/master/webviumvpn/index.html?plain=1"
  ...
  <script src="/js/webviumvpn.js"></script>
</body>
