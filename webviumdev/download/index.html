...
<head>
  ...
  <meta property="twitter:title" content="Thank you for downloading - Webvium Dev" />
  <meta property="twitter:description"
    content="Webvium is a Project that aims to be the lightest, fastest, secured, private and full-featured android web browser." />
  <meta property="og:title" content="Thank you for downloading - Webvium Dev">
  <meta property="og:url" content="https://mrepol742.github.io/webviumdev/download">
  <meta property="og:site_name" content="Thank you for downloading - Webvium Dev">
  ...
  <link rel="canonical" href="https://mrepol742.github.io/webviumdev/download">
  ...
  <title>Thank you for downloading - Webvium Dev</title>
</head>
...
<body class="d-flex flex-column min-vh-100">
  ...
  <nav class="autohide navbar navbar-expand-lg fixed-top scrolled-up scrolled-up-tr">
    <div class="container-fluid">
      <a class="navbar-brand" href="/webviumdev/">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link" href="/webvium#features">Features</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/webvium#info">Information</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/webvium#dataSafety">Data Safety</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/webvium#permissions">Permissions</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/webvium#previousVersion">Previous Version</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/webvium#frequentlyAskQuestions">Faq</a>
          </li>
        </ul>
        <div>
  ...
  <main>
    ...
    <header class="mt-5">
      <h1 class="text-center2">Thank you for downloading Webvium Dev.</h1><br>
    </header>
    <div class="card ">
      <div class="card-body">
        <p>Within a few seconds, your download should begin automatically. If it doesn't, please
          start the <a href="https://mrepol742-released-dev.netlify.app/Webvium-dev.apk" id="retry-download"
            target="_blank">download using this link.</a></p>
        <br>
        <div class="row">
          <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12">
            <h5>
              <i class="fa-solid fa-play"></i>
              Run the Webvium Dev installer
            </h5>
          ...
          <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12">
            ...
            <p>To start your Webvium Dev installation, select 'Yes' from the system dialog.</p>
          </div>
          <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-12">
            <h5>
    ...
    <div class="card mb-5">
      <div class="card-body">
        ...
        <ul class="card-text">
          <li><a href="https://github.com/mrepol742/mrepol742.github.io/edit/master/webviumdev/download/index.html"
              target="_blank">Edit on Github</a></li>
          <li><a
              href="https://github.com/mrepol742/mrepol742.github.io/blob/master/webviumdev/download/index.html?plain=1"
  ...
  <script>
    setTimeout(function () {
      window.location.href = 'https://mrepol742-released-dev.netlify.app/Webvium-dev.apk'
    }, 3000);
