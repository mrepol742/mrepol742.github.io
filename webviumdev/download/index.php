...
<?php
  ...
  $meta = new meta();
  $meta->setTitle(
    "Download Webvium Dev for Android",
    "Lightweight, Fast, Material and Full-Featured Android Web Browser.",
    "https://mrepol742.github.io/webviumdev/download/"
  );
  $meta->setImage("https://mrepol742.github.io/images/webviumdev.png", "Cover Photo");
  $meta->setKeywords("webvium, dev, download");
  ?>
</head>
...
<body class="d-flex flex-column min-vh-100">
  ...
  <main>
    <h1 class="text-center mt-5">Thank you for downloading Webvium Dev.</h1><br>
    <div class="card ">
      <div class="card-body">
        <p>Within a few seconds, your download should begin automatically. If it doesn't, please
          start the <a href="https://mrepol742-released-dev.netlify.app/Webvium-dev.apk" id="retry-download" target="_blank">download using this link.</a></p>
        <br>
        <div class="row">
    ...
    <div class="card mb-5">
      <div class="card-body">
        ...
        <ul class="card-text">
          <li><a href="https://github.com/mrepol742/mrepol742.github.io/edit/master/webviumdev/download/index.html" target="_blank">Edit on Github</a></li>
          <li><a href="https://github.com/mrepol742/mrepol742.github.io/blob/master/webviumdev/download/index.html?plain=1" target="_blank">Source on Github</a></li>
