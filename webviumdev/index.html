...
<head>
  ...
  <meta property="og:image:alt" content="Webvium Dev">
  <meta property="twitter:image:src" content="https://mrepol742.github.io/images/webviumdev.png" />
  <meta property="twitter:title"
    content="Download Webvium Dev - Lightweight, Fast, Material and Full-Featured Android Web Browser." />
  <meta property="twitter:description"
    content="Melvin Jones Repol offers the indev versions of Webvium, test our new features and improvements. The feedback you gave will help us to identify and fix issues, and make Webvium even better." />
  <meta property="og:title"
    content="Download Webvium Dev - Lightweight, Fast, Material and Full-Featured Android Web Browser.">
  <meta property="og:url" content="https://mrepol742.github.io/webviumdev">
  <meta property="og:site_name"
    content="Download Webvium Dev - Lightweight, Fast, Material and Full-Featured Android Web Browser.">
  <meta property="og:description"
    content="Melvin Jones Repol offers the indev versions of Webvium, test our new features and improvements. The feedback you gave will help us to identify and fix issues, and make Webvium even better.">
  <meta property="og:image" content="https://mrepol742.github.io/images/webviumdev.png">
  ...
  <link rel="canonical" href="https://mrepol742.github.io/webviumdev">
  ...
  <link rel="search" type="application/opensearchdescription+xml" href="https://mrepol742.github.io/opensearch.xml"
    title="Search...">
  <script
    type="application/ld+json">{      "@context": "https://schema.org",      "@type": "SoftwareApplication",      "name": "Webvium Dev",      "operatingSystem": "ANDROID",      "applicationCategory": "BrowserApplication",      "aggregateRating": {        "@type": "AggregateRating",        "ratingValue": "4.3",        "ratingCount": "696"      },      "offers": {        "@type": "Offer",        "price": "0"      }    }</script>
  ...
  <title>Download Webvium Dev - Lightweight, Fast, Material and Full-Featured Android Web Browser.</title>
</head>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/webviumbeta/">Beta</a>
          </li>
        </ul>
        <div>
          <ul class="nav navbar-nav" style="flex-direction: row;">
            <li class="nav-item">
              <a class="nav-link" href="/webviumdev/download">
  ...
  <main>
    ...
    <header class="mt-5">
      <div class="card mb-3 ">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="/images/webvium_transparent_icon.png" class="rounded mx-auto d-block img-fluid" alt="Webvium Dev"
              width="300">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <br>
              <h1 class="card-title"><strong>Webvium Dev</strong></h1>
    ...
    <div class="images">
      <div class="holder">
        <video preload="none" class="preview0" controls poster="/images/webviumdev.png">
          <source
        ...
        <img loading="lazy" class="preview" src="/images/webvium-1.jpg" alt="Webvium Dev App Screenshot">
        <img loading="lazy" class="preview" src="/images/webvium-2.jpg" alt="Webvium Dev App Screenshot">
        <img loading="lazy" class="preview" src="/images/webvium-3.jpg" alt="Webvium Dev App Screenshot">
        <img loading="lazy" class="preview" src="/images/webvium-4.jpg" alt="Webvium Dev App Screenshot">
        <img loading="lazy" class="preview" src="/images/webvium-5.jpg" alt="Webvium Dev App Screenshot">
        <img loading="lazy" class="preview" src="/images/webvium-6.jpg" alt="Webvium Dev App Screenshot">
        <img loading="lazy" class="preview" src="/images/webvium-7.jpg" alt="Webvium Dev App Screenshot">
        <img loading="lazy" class="preview" src="/images/webvium-8.jpg" alt="Webvium Dev App Screenshot">
      </div>
    </div>
    <br>
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <div class="card mb-3 ">
          <h5 class="card-header">Dev Test</h5>
          <div class="card-body">
            <p class="card-text">
              Test the recently added changes to the Webvium Repository as soon as it get updated. Report any Software
              crashes as soon as possible to address them quickly.
            </p>
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="card mb-3 ">
          ...
          <div class="card-body">
            <p class="card-text">
              <a href="https://facebook.com/com.mrepol742.webvium.dev" style="padding-left: 5px; padding-right: 5px;"
                target="_blank">
                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                  <title>Webvium Dev's Facebook</title>
          ...
          <div id="panelsStayOpen-collapseOne3" class="accordion-collapse collapse show"
            ...
            <div class="accordion-body">
              <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">Latest release: <span id="upda">Feb 7, 2022</span></li>
    ...
    <div class="card mb-5">
      <div class="card-body">
        ...
        <ul class="card-text">
          <li><a href="https://github.com/mrepol742/mrepol742.github.io/edit/master/webviumdev/index.html"
              target="_blank">Edit on Github</a></li>
          <li><a href="https://github.com/mrepol742/mrepol742.github.io/blob/master/webviumdev/index.html?plain=1"
  ...
  <script src="/js/webviumdev.js"></script>
</body>
