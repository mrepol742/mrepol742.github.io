...
<head>
  ...
  $meta = new meta();
  $meta->setTitle(
    "Samiun Nafis - Front-end Developer - samiunnafis",
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
          <div class="card asd " id="samiunnafis" style="border-radius: 10px;">
            <div class="card-body">
              ...
              <a href="https://samiunnafis.github.io/" aria-label="Website" style="padding-left: 5px; padding-right: 5px;" target="_blank">
                <i class="fa-solid fa-code"></i>
              </a>
              <a href="https://github.com/samiunnafis" aria-label="Github" style="padding-left: 5px; padding-right: 5px;" target="_blank">
                <i class="fa-brands fa-github"></i>
              </a>
              <a href="https://linkedin.com/in/samiunnafis" aria-label="LinkedIn" style="padding-left: 5px; padding-right: 5px;" target="_blank">
                <i class="fa-brands fa-linkedin"></i>
              </a><br>
              <a href="https://github.com/mrepol742/mrepol742.github.io/blob/master/friends/samiunnafis/index.php" class="mt-2" style="padding-left: 5px; padding-right: 5px;" target="_blank">
