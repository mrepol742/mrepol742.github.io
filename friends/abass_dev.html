...
<head>
    ...
    <meta property="og:title" content="Abass Dev - Mobile App Developer Profile Card">
    <meta property="og:url" content="https://mrepol742.github.io/friends/abass_dev.html">
    <meta property="og:site_name" content="Abass Dev - Mobile App Developer Profile Card">
    ...
    <link rel="canonical" href="https://mrepol742.github.io/friends/abass_dev.html">
    ...
    <title>Abass Dev - Mobile App Developer Profile Card</title>
</head>
    ...
    <main>
        <div class="container" style="margin-top:3em;">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card asd " id="abass_dev" style="border-radius: 10px;">
                        <div class="card-body">
                            <img loading="lazy" src="https://avatars.githubusercontent.com/abass-dev"
                                class="mx-auto d-block img-fluid circle-png" alt="Abass Dev avatar at Github"
                                width="150">
                            <h5 class="title mb-1 mt-3 text-capitalize">Abass Dev</h5>
                            <p class="card-text">A passionate web and mobile app developer with over 6 years of
                                experience in programming
                                and the internet.
                            </p>
                            <p class="card-text"><small class="text-muted">@abass_dev</small></p>
                            <a href="https://abassdev.com" style="padding-left: 5px; padding-right: 5px;"
                                target="_blank">
                                <i class="fa-solid fa-code"></i>
                            </a>
                            <a href="https://github.com/abass_dev" style="padding-left: 5px; padding-right: 5px;"
                                target="_blank">
                                <i class="fa-brands fa-github"></i>
                            </a>
                            <a href="https://www.linkedin.com/m/in/abassdev"
                                style="padding-left: 5px; padding-right: 5px;" target="_blank">
