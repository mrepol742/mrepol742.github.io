...
<head>
    ...
    <meta property="og:title" content="Emmanuel Emejulu - Mobile App Developer Profile Card">
    <meta property="og:url" content="https://mrepol742.github.io/friends/emejulucodes.html">
    <meta property="og:site_name" content="Emmanuel Emejulu - Mobile App Developer Profile Card">
    ...
    <link rel="canonical" href="https://mrepol742.github.io/friends/emejulucodes.html">
    ...
    <title>Emmanuel Emejulu - Mobile App Developer Profile Card</title>
</head>
                    ...
                    <div class="card asd" id="emejulucodes" style="border-radius: 10px;">
                        <div class="card-body">
                            <img loading="lazy" src="https://avatars.githubusercontent.com/u/54607888?v=4"
                                class="mx-auto d-block img-fluid circle-png" alt="Emmanuel Emejulu avatar at Github"
                                width="150">
                            <h5 class="title mb-1 mt-3 text-capitalize">Emmanuel Emejulu</h5>
                            <p class="card-text">A highly experienced web and mobile app developer with expertise in a
                                wide range of technologies. He is currently employed at a leading app development
                                company, where he is
                                working on innovative projects.</p>
                            <p class="card-text"><small class="text-muted">@emejulucodes</small></p>
                            <a href="https://github.com/emejulucodes" style="padding-left: 5px; padding-right: 5px;"
                                target="_blank">
                                <i class="fa-brands fa-github"></i>
                            </a>
                            <a href="https://linkedin.com/in/emejulucodes"
