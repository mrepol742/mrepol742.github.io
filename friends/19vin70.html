...
<head>
    ...
    <meta property="og:title" content="Marvin Quillo Saik - Programmer Profile Card">
    <meta property="og:url" content="https://mrepol742.github.io/friends/19vin70.html">
    <meta property="og:site_name" content="Marvin Quillo Saik - Programmer Profile Card">
    ...
    <link rel="canonical" href="https://mrepol742.github.io/friends/19vin70.html">
    ...
    <title>Marvin Quillo Saik - Programmer Profile Card</title>
</head>
                    ...
                    <div class="card asd " id="19vin70" style="border-radius: 10px;">
                        <div class="card-body">
                            <img loading="lazy" src="https://avatars.githubusercontent.com/u/113106676?v=4"
                                class="mx-auto d-block img-fluid circle-png" alt="Marvin Quillo Saik avatar at Github"
                                width="150">
                            ...
                            <p class="card-text"><small class="text-muted">@19vin70</small></p>
                            <a href="https://kabe.vercel.app" style="padding-left: 5px; padding-right: 5px;"
                                target="_blank">
                                <i class="fa-solid fa-code"></i>
                            </a>
                            <a href="https://github.com/19vin70" style="padding-left: 5px; padding-right: 5px;"
                                target="_blank">
