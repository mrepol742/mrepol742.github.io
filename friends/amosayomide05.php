...
<head>
    ...
    <meta property="og:title" content="Amos Ayomide - Programmer Profile Card">
    <meta property="og:url" content="https://mrepol742.github.io/friends/amosayomide05.html">
    <meta property="og:site_name" content="Amos Ayomide - Programmer Profile Card">
    ...
    <link rel="canonical" href="https://mrepol742.github.io/friends/amosayomide05.html">
    ...
    <title>Amos Ayomide - Programmer Profile Card</title>
</head>
                    ...
                    <div class="card asd " id="amosayomide05" style="border-radius: 10px;">
                        <div class="card-body">
                            <img loading="lazy" src="https://avatars.githubusercontent.com/u/62471060?v=4"
                                class="mx-auto d-block img-fluid circle-png" alt="Amos Ayomide avatar at Github"
                                width="150">
                            ...
                            <p class="card-text">A highly skilled programmer who has a passion for web development. He
                                has
                                been teaching himself programming since high school and is now working towards a degree
                                in computer science.
                            </p>
                            <p class="card-text"><small class="text-muted">@amosayomide05</small></p>
                            <a href="https://amosayomide05.github.io/" style="padding-left: 5px; padding-right: 5px;"
                                target="_blank">
                                <i class="fa-solid fa-code"></i>
                            </a>
                            <a href="https://github.com/amosayomide05" style="padding-left: 5px; padding-right: 5px;"
                                target="_blank">
