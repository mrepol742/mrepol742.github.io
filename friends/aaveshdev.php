...
<head>
    ...
    <meta property="og:title" content="Aavesh Jilani - Programmer Profile Card">
    <meta property="og:url" content="https://mrepol742.github.io/friends/aaveshdev.html">
    <meta property="og:site_name" content="Aavesh Jilani - Programmer Profile Card">
    ...
    <link rel="canonical" href="https://mrepol742.github.io/friends/aaveshdev.html">
    ...
    <title>Aavesh Jilani - Programmer Profile Card</title>
</head>
                    ...
                    <div class="card asd " id="aaveshdev" style="border-radius: 10px;">
                        <div class="card-body">
                            <img loading="lazy" src="https://avatars.githubusercontent.com/u/50949867?v=4"
                                class="mx-auto d-block img-fluid circle-png" alt="Aavesh Jilani avatar at Github"
                                width="150">
                            ...
                            <p class="card-text">Renowned software engineer and has been credited for his work on the
                                ...
                                co-author of the Citrine
                                Programming Language.
                            </p>
                            <p class="card-text"><small class="text-muted">@aaveshdev</small></p>
                            <a href="https://aavesh.dragon-lang.org/" style="padding-left: 5px; padding-right: 5px;"
                                target="_blank">
                                <i class="fa-solid fa-code"></i>
                            </a>
                            <a href="https://github.com/aaveshdev" style="padding-left: 5px; padding-right: 5px;"
                                target="_blank">
                                <i class="fa-brands fa-github"></i>
                            </a>
                            <a href="https://linkedin.com/in/aaveshjilani"
