...
<head>
  ...
  <meta property="twitter:description"
    content="A phrase that is often used to introduce someone to the world of programming." />
  <meta property="og:title" content="What's Hello World?">
  <meta property="og:url" content="https://mrepol742.github.io/helloworld">
  <meta property="og:site_name" content="What's Hello World?">
  <link rel="license" href="https://raw.githubusercontent.com/mrepol742/mrepol742.github.io/master/LICENSE">
  <link rel="canonical" href="https://mrepol742.github.io/helloworld">
  ...
  <meta property="og:description"
    content="A phrase that is often used to introduce someone to the world of programming.">
  <meta property="og:image" content="https://mrepol742.github.io/images/helloworld.jpg">
  <meta name="theme-color" content="#ffffff">
  <meta name="keywords" content="melvin jones repol, mrepol742, hello world">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="description" content="A phrase that is often used to introduce someone to the world of programming.">
  ...
  <title>What's Hello World?</title>
</head>
...
<body class="d-flex flex-column min-vh-100">
  ...
  <main>
    ...
    <div class="text-center2">
      <h1>What's 'Hello World'?</h1>
      <img src="/images/helloworld.jpg" class="rounded mx-auto d-block img-fluid" alt="Hello World"> <br>
      <p style="text-align: left;">
        ...
        <br><br>In programming, the phrase "Hello world" is often used to demonstrate the basic syntax of a
        language. It is a simple statement that prints the phrase "Hello world" to the screen. This
        statement is usually the first thing a programmer will write when learning a new language. It is a
        way to test the language and make sure that it is working correctly. <br><br>The phrase "Hello
        ...
        are used to create objects and can be used to create custom objects. <br><br>In conclusion, the
        phrase "Hello world" is a simple phrase that is used to demonstrate the basic syntax of a
        programming language. It is a way to test the language and make sure that it is working correctly.
        It can also be used to demonstrate more complex concepts such as variables, functions, and classes.
      </p>
    </div>
    <br>
    <div class="card mb-5">
      <div class="card-body">
        ...
        <ul class="card-text">
          <li><a href="https://github.com/mrepol742/mrepol742.github.io/edit/master/helloworld/index.html"
              target="_blank">Edit on Github</a></li>
          <li><a href="https://github.com/mrepol742/mrepol742.github.io/blob/master/helloworld/index.html?plain=1"
